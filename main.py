#!/usr/bin/env python3
# ---------------------------------------------------------------------------
#  gmail by safouane — Automated Account Creation Engine
# ---------------------------------------------------------------------------
#  Author  : safouane02.github
#  Version : 2026.1.0
# ---------------------------------------------------------------------------

"""Main entry point for the gmail by safouane application.
...
class AppLogger:
    ...
    def __init__(self, name: str = "gmail_by_safouane"):
        self.name = name
    ...
    def _save_test_proxies(self):
        ...
        try:
            with open(PROXIES_FILE, 'w', encoding='utf-8') as f:
                f.write("# GMAIL BY SAFOUANE - PROXY LIST\n")
...
# ============================================================================
# INTERACTIVE TUI - GMAIL BY SAFOUANE
# ============================================================================
...
def draw_header():
    ...
    print(f"{C}│{RST}")
    print(f"{C}│{RST}                 {C}«« {W}{B}GMAIL BY SAFOUANE{RST} {C}»»{RST}")
            ...
            if choice == '1':
                ...
                if int(stats.get('total_attempts', 0)) > 0:
                    ...
                    try:
                        ...
                        pass
                print(f"  {M}>> gmail by safouane offline.{RST}\n")
